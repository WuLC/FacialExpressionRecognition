...
# @Last Modified time: 2017-09-26 11:32:48
...
class AlexNet:
    def __init__(self,
                 json_path = './model_weights/D222_CK+_KDEF_JAFFFE_alexnet_200epochs_json',
                 weight_path = './model_weights/D222_CK+_KDEF_JAFFFE_alexnet_200epochs_weight'):
        # load model
        self.model = None
...
if __name__ == '__main__':
    ...
    json_path = './model_weights/D10_CKplus_alexnet_150epochs_json'
    weight_path = './model_weights/D10_CKplus_alexnet_150epochs_weight'
